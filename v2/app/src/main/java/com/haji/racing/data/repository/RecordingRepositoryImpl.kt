...
class RecordingRepositoryImpl @Inject constructor(
    ...
    override suspend fun getLatestRecordingForTrack(trackUid: String): Recording? =
        recordingDao.getLatestRecordingForTrack(trackUid)?.toDomain()
    ...
    override suspend fun getTotalDistanceForUser(userUid: String): Double =
        recordingDao.getTotalDistanceForUser(userUid) ?: 0.0
